# DDYO G_j Context Extract

## Target

Extract repository context windows relevant to the theorem-level target
\[
...
```text
./artifacts/audit/generate_ddyo_terminal_frontier_core.py-13-
./artifacts/audit/generate_ddyo_terminal_frontier_core.py-14-priority_keys = (
./artifacts/audit/generate_ddyo_terminal_frontier_core.py-15-    "GRADIENT_BOUND",
./artifacts/audit/generate_ddyo_terminal_frontier_core.py-16-    "GJ_",
./artifacts/audit/generate_ddyo_terminal_frontier_core.py:17:    "G_j",
./artifacts/audit/generate_ddyo_terminal_frontier_core.py-18-    "RA1N",
./artifacts/audit/generate_ddyo_terminal_frontier_core.py-19-    "TERMINAL_OBSTRUCTION",
./artifacts/audit/generate_ddyo_terminal_frontier_core.py-20-    "SHELL_PRODUCT",
./artifacts/audit/generate_ddyo_terminal_frontier_core.py-21-    "SOLVE_REQUIREMENTS",
--
...
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:1:# DDYO G_j Structural Candidates
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-2-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-3-## Purpose
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-4-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:5:Repository-wide structural search for the exact construction of \(G_j\) sufficient to prove
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-6-\[
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-8-\]
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-9-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:10:## Literal hits for \(G_j\)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-11-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-12-```text
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:13:./docs/math/DDYO_RA1N_ANNULAR_POTENTIAL_ESTIMATE.md:40:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:14:./docs/math/DDYO_RA1N_ANNULAR_POTENTIAL_ESTIMATE.md:45:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:15:./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:8:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:16:./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:19:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:17:./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:42:2. The shell product \(G_j\cdot e^{(j)}_{ab}(D)\omega_k\) has zero mean.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:18:./docs/math/DDYO_OPEN_PROBLEM_SHELL_PRODUCT_MOMENT.md:9:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:19:./docs/math/DDYO_OPEN_PROBLEM_SHELL_PRODUCT_MOMENT.md:17:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:20:./docs/math/DDYO_MASSIVE_REDUCTION.md:49:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:21:./docs/math/DDYO_MASSIVE_REDUCTION.md:86:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:22:./docs/math/DDYO_MASSIVE_REDUCTION.md:100:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:23:./docs/math/DDYO_MASSIVE_REDUCTION.md:131:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:24:./docs/math/DDYO_MASSIVE_REDUCTION.md:134:The repository-wide provenance audit has been introduced precisely because theorem-level closure of this bound requires the exact structural construction of \(G_j\).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:25:./docs/math/DDYO_MASSIVE_REDUCTION.md:147:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:26:./docs/math/DDYO_MASSIVE_REDUCTION.md:169:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:27:./docs/math/DDYO_MASSIVE_REDUCTION.md:186:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:28:./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:54:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:29:./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:58:\int G_j\cdot [\widetilde P_j,S_k\!\cdot\nabla]\omega_k\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:30:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:52:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:31:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:57:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:32:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:67:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:33:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:5:Assume there exists an explicit theorem-level construction of \(G_j\) such that
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:34:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:7:G_j(x)=2^{2j}\Gamma(2^j x)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:35:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:16:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:36:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:25:No theorem-level proof of the required explicit construction of \(G_j\) is currently present in this repository.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:37:./docs/math/BRANCH_B_FINAL_FRONTIER.md:16:\int x_l\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:38:./docs/math/BRANCH_B_FINAL_FRONTIER.md:24:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:39:./docs/math/BRANCH_B_FINAL_FRONTIER.md:41:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:40:./docs/math/BRANCH_B_FINAL_FRONTIER.md:49:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:41:./docs/math/BRANCH_B_FINAL_FRONTIER.md:54:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:42:./docs/math/BRANCH_B_FINAL_FRONTIER.md:76:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:43:./docs/math/BRANCH_B_FINAL_FRONTIER.md:142:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:44:./docs/math/BRANCH_B_FINAL_FRONTIER.md:149:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:45:./docs/math/BRANCH_B_FINAL_FRONTIER.md:158:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:46:./docs/math/BRANCH_B_FINAL_FRONTIER.md:167:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:47:./docs/math/BRANCH_B_FINAL_FRONTIER.md:178:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:48:./docs/math/BRANCH_B_FINAL_FRONTIER.md:211:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:49:./docs/math/BRANCH_B_FINAL_FRONTIER.md:216:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:50:./docs/math/BRANCH_B_FINAL_FRONTIER.md:233:\int x_l\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:51:./docs/math/BRANCH_B_FINAL_FRONTIER.md:241:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:52:./docs/math/DDYO_RA1N_GJ_DEFINITION_STATUS.md:1:# DDYO RA1n G_j Definition Status
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:53:./docs/math/DDYO_RA1N_GJ_DEFINITION_STATUS.md:5:Repository-wide literal search found references to \(G_j\) but no explicit theorem-level construction of \(G_j\).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:54:./docs/math/DDYO_RA1N_GJ_DEFINITION_STATUS.md:11:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:55:./docs/math/DDYO_RA1N_GJ_DEFINITION_STATUS.md:19:No explicit theorem-level definition of \(G_j\) is currently recorded in this repository.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:56:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:8:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:57:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:22:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:58:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:35:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:59:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:43:\int (\partial_b S_k^a)\,\bigl(G_j\cdot e^{(j)}_{ab}(D)\omega_k\bigr)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:60:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:47:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:61:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:34:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:62:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:36:-\int_{\mathbb R^3}\partial_m\!\bigl(x_\ell G_j(x)\bigr)\,H^{ab}_{j,k,m}(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:63:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:41:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:64:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:44:\|\nabla(x_\ell G_j)\|_{L^\infty}\,\|H^{ab}_{j,k}\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:65:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:49:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:66:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:54:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:67:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:64:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:68:./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:10:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:69:./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:15:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:70:./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:25:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:71:./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:33:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:72:./docs/math/DDYO_RA1N_PROOF.md:13:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:73:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:74:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:14:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:75:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:19:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:76:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:31:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:77:./docs/math/DDYO_RA1N_OPEN_PROBLEM.md:8:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:78:./docs/math/DDYO_RA1N_OPEN_PROBLEM.md:16:\int_{\mathbb R^3} G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:79:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:5:For the dyadic kernel factor \(G_j\),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:80:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:81:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:21:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:82:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:25:\int_{\mathbb R^3}\partial_m(x_\ell G_j)(x)\,H^{ab}_{j,k,m}(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:83:./docs/math/DDYO_RA1N_MOMENT_BOUND_PROOF.md:6:\left| \int x_\ell \, G_j(x) \, e^{(j)}_{ab}(D) \omega_k(x) \, dx \right| \le C \, 2^{-j} 2^{-k} \|\omega_k\|_{L^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:84:./docs/math/DDYO_RA1N_MOMENT_BOUND_PROOF.md:10:1. **Fourier Representation**: Let K(x) = G_j(x)\,[e^{(j)}_{ab}(D)\omega_k](x). The first moment is:
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:85:./docs/math/DDYO_CANONICAL_FRONTIER.md:8:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:86:./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:20:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:87:./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:30:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:88:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:89:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:14:To prove it in this repository, one still needs the exact construction of \(G_j\), equivalently the precise definition of its Fourier multiplier or kernel normalization, together with any cancellation, support, or rescaling identities used in the estimate.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:90:./docs/math/DDYO_TERMINAL_OBSTRUCTION.md:12:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:91:./docs/math/DDYO_TERMINAL_OBSTRUCTION.md:30:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:92:./docs/math/DDYO_TERMINAL_OBSTRUCTION.md:35:To prove the terminal obstruction, the repository still requires the exact theorem-level construction of \(G_j\) sufficient to derive the scale-sharp gradient estimate.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:93:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:8:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:94:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:16:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:95:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:21:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:96:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:36:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:97:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:1:# DDYO RA1n G_j Provenance Audit
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:98:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:5:Search the repository for the exact construction of \(G_j\) needed for the remaining gradient-bound target
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:99:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:100:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:10:## Raw repository hits for \(G_j\)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:101:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:13:./docs/status/DDYO_RA1N_STATUS_2026_04_10.md:21:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:102:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:14:./docs/status/DDYO_RA1N_STATUS_2026_04_10.md:26:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:103:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:15:./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md:12:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:104:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:16:./docs/status/SCIENTIFIC_MATURITY_CURRENT.md:15:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:105:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:17:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:52:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:106:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:18:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:57:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:107:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:19:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:67:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:108:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:20:./docs/math/DDYO_RA1N_ANNULAR_POTENTIAL_ESTIMATE.md:40:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:109:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:21:./docs/math/DDYO_RA1N_ANNULAR_POTENTIAL_ESTIMATE.md:45:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:110:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:22:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:34:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:111:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:23:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:36:-\int_{\mathbb R^3}\partial_m\!\bigl(x_\ell G_j(x)\bigr)\,H^{ab}_{j,k,m}(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:112:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:24:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:41:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:113:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:25:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:44:\|\nabla(x_\ell G_j)\|_{L^\infty}\,\|H^{ab}_{j,k}\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:114:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:26:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:49:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:115:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:27:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:54:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:116:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:28:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:64:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:117:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:29:./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:10:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:118:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:30:./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:15:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:119:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:31:./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:25:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:120:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:32:./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:33:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:121:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:33:./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:8:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:122:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:34:./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:19:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:123:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:35:./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:42:2. The shell product \(G_j\cdot e^{(j)}_{ab}(D)\omega_k\) has zero mean.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:124:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:36:./docs/math/DDYO_RA1N_OPEN_PROBLEM.md:8:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:125:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:37:./docs/math/DDYO_RA1N_OPEN_PROBLEM.md:16:\int_{\mathbb R^3} G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:126:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:38:./docs/math/DDYO_OPEN_PROBLEM_SHELL_PRODUCT_MOMENT.md:9:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:127:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:39:./docs/math/DDYO_OPEN_PROBLEM_SHELL_PRODUCT_MOMENT.md:17:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:128:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:40:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:5:For the dyadic kernel factor \(G_j\),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:129:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:41:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:130:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:42:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:21:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:131:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:43:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:25:\int_{\mathbb R^3}\partial_m(x_\ell G_j)(x)\,H^{ab}_{j,k,m}(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:132:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:44:./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:54:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:133:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:45:./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:58:\int G_j\cdot [\widetilde P_j,S_k\!\cdot\nabla]\omega_k\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:134:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:46:./docs/math/BRANCH_B_FINAL_FRONTIER.md:16:\int x_l\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:135:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:47:./docs/math/BRANCH_B_FINAL_FRONTIER.md:24:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:136:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:48:./docs/math/BRANCH_B_FINAL_FRONTIER.md:41:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:137:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:49:./docs/math/BRANCH_B_FINAL_FRONTIER.md:49:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:138:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:50:./docs/math/BRANCH_B_FINAL_FRONTIER.md:54:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:139:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:51:./docs/math/BRANCH_B_FINAL_FRONTIER.md:76:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:140:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:52:./docs/math/BRANCH_B_FINAL_FRONTIER.md:142:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:141:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:53:./docs/math/BRANCH_B_FINAL_FRONTIER.md:149:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:142:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:54:./docs/math/BRANCH_B_FINAL_FRONTIER.md:158:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:143:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:55:./docs/math/BRANCH_B_FINAL_FRONTIER.md:167:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:144:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:56:./docs/math/BRANCH_B_FINAL_FRONTIER.md:178:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:145:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:57:./docs/math/BRANCH_B_FINAL_FRONTIER.md:211:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:146:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:58:./docs/math/BRANCH_B_FINAL_FRONTIER.md:216:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:147:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:59:./docs/math/BRANCH_B_FINAL_FRONTIER.md:233:\int x_l\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:148:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:60:./docs/math/BRANCH_B_FINAL_FRONTIER.md:241:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:149:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:61:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:150:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:62:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:14:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:151:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:63:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:19:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:152:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:64:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:31:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:153:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:65:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:8:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:154:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:66:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:22:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:155:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:67:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:35:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:156:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:68:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:43:\int (\partial_b S_k^a)\,\bigl(G_j\cdot e^{(j)}_{ab}(D)\omega_k\bigr)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:157:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:69:./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:47:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:158:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:70:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:159:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:71:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:14:To prove it in this repository, one still needs the exact construction of \(G_j\), equivalently the precise definition of its Fourier multiplier or kernel normalization, together with any cancellation, support, or rescaling identities used in the estimate.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:160:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:72:./docs/math/DDYO_RA1N_PROOF.md:13:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:161:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:73:./docs/math/DDYO_RA1N_MOMENT_BOUND_PROOF.md:6:\left| \int x_\ell \, G_j(x) \, e^{(j)}_{ab}(D) \omega_k(x) \, dx \right| \le C \, 2^{-j} 2^{-k} \|\omega_k\|_{L^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:162:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:74:./docs/math/DDYO_RA1N_MOMENT_BOUND_PROOF.md:10:1. **Fourier Representation**: Let K(x) = G_j(x)\,[e^{(j)}_{ab}(D)\omega_k](x). The first moment is:
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:163:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:75:./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:20:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:164:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:76:./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:30:\int_{\mathbb R^3} x_\ell G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:165:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:77:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:8:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:166:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:78:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:16:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:167:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:79:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:21:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:168:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:80:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:36:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:169:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:81:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:6:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:170:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:82:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:11:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:171:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:83:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:20:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:172:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:84:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:29:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:173:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:85:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:42:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:174:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:86:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:1:# DDYO RA1n G_j Provenance Audit
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:175:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:87:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:5:Search the repository for the exact construction of \(G_j\) needed for the remaining gradient-bound target
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:176:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:88:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:177:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:89:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:10:## Raw repository hits for \(G_j\)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:178:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:90:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:16:./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:54:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:179:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:91:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:17:./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:62:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:180:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:92:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:21:If NO_DEFINITION_HITS appears above, then no explicit theorem-level definition of \(G_j\) was found by this repository-wide text search, and the gradient-bound route still lacks the exact structural input required for closure.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:181:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:93:./docs/math/DDYO_RA1N_TARGET_THEOREM.md:8:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:182:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:94:./docs/math/DDYO_CANONICAL_FRONTIER.md:8:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:183:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:95:./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:62:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:184:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:96:./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:66:\int G_j\cdot [\widetilde P_j,S_k\!\cdot\nabla]\omega_k\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:185:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:97:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:8:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:186:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:98:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:15:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:187:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:99:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:24:\bigl\|G_j\cdot e^{(j)}_{ab}(D)\omega_k\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:188:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:100:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:33:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:189:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:104:./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:54:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:190:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:105:./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:62:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:191:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:106:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:16:./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:54:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:192:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:107:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:17:./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:62:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:193:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:111:If NO_DEFINITION_HITS appears above, then no explicit theorem-level definition of \(G_j\) was found by this repository-wide text search, and the gradient-bound route still lacks the exact structural input required for closure.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:194:./docs/math/DDYO_RA1N_TARGET_THEOREM.md:8:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:195:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:8:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:196:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:15:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:197:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:24:\bigl\|G_j\cdot e^{(j)}_{ab}(D)\omega_k\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:198:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:33:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:199:./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:62:G_j:=\mathcal H'_\tau(\omega_j),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:200:./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:66:\int G_j\cdot [\widetilde P_j,S_k\!\cdot\nabla]\omega_k\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:201:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:6:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:202:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:11:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:203:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:20:\bigl\|\,G_j\cdot e^{(j)}_{ab}(D)\omega_k\,\bigr\|_{H^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:204:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:29:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:205:./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:42:\int G_j\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:206:./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md:12:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:207:./docs/status/DDYO_RA1N_STATUS_2026_04_10.md:21:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:208:./docs/status/DDYO_RA1N_STATUS_2026_04_10.md:26:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:209:./docs/status/SCIENTIFIC_MATURITY_CURRENT.md:15:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-210-```
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-211-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-212-## Kernel / \(\Gamma\) / scaling-candidate hits
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-213-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-214-```text
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-215-./docs/math/DDYO_PAIRED_DECOMPOSITION_5P_COVERAGE.md:19:\int \Gamma_{j,k}(x):\operatorname{Sym}\nabla S_k(x)\,dx,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-216-./docs/math/DDYO_PAIRED_DECOMPOSITION_5P_COVERAGE.md:56:\int \Gamma_{j,k}:\operatorname{Sym}\nabla S_k\,dx.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:217:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:7:G_j(x)=2^{2j}\Gamma(2^j x)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-218-./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:9:for some fixed kernel \(\Gamma\) satisfying
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-219-./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:11:\nabla(x_\ell \Gamma)\in L^\infty(\mathbb R^3).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-220-./docs/math/DDYO_HYBRID_CLAIM5_ROUTE.md:28:\int \Gamma_{j,k}:\operatorname{Sym}\nabla S_k\,dx,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-221-./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:15:\int \Gamma_{j,k}(x):\operatorname{Sym}\nabla S_k(x)\,dx,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-222-./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:60:\int \Gamma_{j,k}:\operatorname{Sym}\nabla S_k\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-223-./docs/math/DDYO_CLAIM5_TARGET.md:9:\int \Gamma_{j,k}:\operatorname{Sym}\nabla S_k\,dx+\mathsf R_{j,k},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-224-./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:35:\int \Gamma_{j,k}(x):\operatorname{Sym}\nabla S_k(x)\,dx,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-225-./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:68:\int \widetilde\Gamma_{j,k}:\operatorname{Sym}\nabla S_k\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:226:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:7:G_j(x)=2^{2j}\Gamma(2^j x)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-227-./modules/rh/akcl/akcl_uniformization.md:31:D(L) captures kernel mass growth.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-228-./tests/test_ddyo_hybrid_proxy.py:10:def make_even_gaussian_kernel(n, sigma_pts):
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-229-./tests/test_ddyo_hybrid_proxy.py:31:    K = make_even_gaussian_kernel(n, sigma_pts)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-230-./tests/test_ddyo_hybrid_proxy.py:53:def test_hybrid_proxy_even_kernel_has_zero_signed_first_moment():
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-245-./docs/math/DDYO_MASSIVE_REDUCTION.md:56:\text{fixed-scale Schwartz-kernel bound}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-246-./docs/math/DDYO_MASSIVE_REDUCTION.md:60:\text{fixed-scale Schwartz-kernel bound}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-247-./docs/math/DDYO_MASSIVE_REDUCTION.md:105:The annular potential estimate reduces to the fixed-scale multiplier-kernel route:
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-248-./docs/math/DDYO_MASSIVE_REDUCTION.md:125:At fixed scale, the annular cutoff removes the origin singularity, so the multiplier is smooth and compactly supported away from the singular point. This is the recorded local route to the \(L^1\) kernel bound.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:249:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:14:To prove it in this repository, one still needs the exact construction of \(G_j\), equivalently the precise definition of its Fourier multiplier or kernel normalization, together with any cancellation, support, or rescaling identities used in the estimate.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-250-./docs/math/DDYO_MOLLIFIED_SKEW_CANCELLATION.md:5:Let \((\widetilde P_j)_j\) be a smooth positive dyadic family with even real symbol and convolution kernel \(K_j(x-y)\).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-251-./docs/math/DDYO_MOLLIFIED_SKEW_CANCELLATION.md:24:Using the kernel representation,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-252-./docs/math/DDYO_HYBRID_CLAIM5_ROUTE.md:9:3. kernel symmetrization to remove the first-order paired leakage,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-253-./docs/math/DDYO_HYBRID_CLAIM5_ROUTE.md:42:The first factor \(2^{-j}\) is supplied by the kernel first moment:
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-258-./docs/math/DDYO_POST_SYMMETRIZED_FIRST_ORDER_LEAKAGE.md:9:denote the first-order Taylor contribution to the paired commutator remainder after kernel symmetrization in the hybrid route.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-259-./docs/math/DDYO_POST_SYMMETRIZED_FIRST_ORDER_LEAKAGE.md:37:This isolates the only unresolved first-order leakage object in the hybrid paired/Taylor/kernel route.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-260-./docs/math/DDYO_COUNTEREXAMPLE_ZERO_SHELL_MEAN_NOT_SUFFICIENT.md:55:without an additional dipole / Taylor / kernel cancellation mechanism is false.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-261-./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:49:## Required kernel gain
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:262:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:5:For the dyadic kernel factor \(G_j\),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-263-./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:5:By the reduction chain and the fixed-scale Schwartz-kernel route, the remaining theorem-level local task for RA1n is the bound
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:264:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:40:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:5:For the dyadic kernel factor \(G_j\),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:265:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:71:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:14:To prove it in this repository, one still needs the exact construction of \(G_j\), equivalently the precise definition of its Fourier multiplier or kernel normalization, together with any cancellation, support, or rescaling identities used in the estimate.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-266-```
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-267-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-268-## Dyadic-scaling hits
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-269-
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-283-./docs/math/DDYO_SYMMETRIC_COMMUTATOR_PAIRING_FRONTIER.md:31:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [P_j,S_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-284-./docs/math/DDYO_SYMMETRIC_COMMUTATOR_PAIRING_FRONTIER.md:68:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,\Omega_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx = 0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-285-./docs/math/DDYO_SYMMETRIC_COMMUTATOR_PAIRING_FRONTIER.md:73:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,S_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-286-./docs/math/BRANCH_B_CLOSURE_CHECKLIST.md:119:- `docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:11:extract the exact shellwise gain needed to offset the DDYO weight \(2^{2j}\).`
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:287:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:7:G_j(x)=2^{2j}\Gamma(2^j x)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-288-./docs/math/DDYO_MOLLIFIED_SYMMETRIC_COMMUTATOR_BOUND.md:9:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,S_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-289-./docs/math/DDYO_MOLLIFIED_SYMMETRIC_COMMUTATOR_BOUND.md:39:with a dyadic gain strong enough after multiplication by \(2^{2j}\) and summation to yield one global \(\varepsilon<1\).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:290:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:7:G_j(x)=2^{2j}\Gamma(2^j x)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-291-./artifacts/branch_b/branch_b_frontier_matrix.md:39:  L18: C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-292-./docs/status/DDYO_RA1N_STATUS_2026_04_10.md:29:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-293-./artifacts/branch_b/branch_b_open_hits.log:21:docs/status/DDYO_RA1N_STATUS_2026_04_10.md:29:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-294-./artifacts/branch_b/branch_b_open_hits.log:50:docs/math/DDYO_RA1N_CONDITIONAL.md:18:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-295-./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md:15:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-296-./docs/status/SCIENTIFIC_MATURITY_CURRENT.md:18:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:297:./docs/math/DDYO_RA1N_ANNULAR_POTENTIAL_ESTIMATE.md:40:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-298-./docs/math/DDYO_RA1N_ANNULAR_POTENTIAL_ESTIMATE.md:48:C\,2^{-j}2^{-k}\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:299:./docs/math/DDYO_TERMINAL_OBSTRUCTION.md:12:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:300:./docs/math/DDYO_TERMINAL_OBSTRUCTION.md:30:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-301-./docs/math/DDYO_KERNEL_FIRST_MOMENT_LEMMA.md:7:\int |K_j(z)|\,|z|\,dz \lesssim 2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-302-./docs/math/DDYO_CLAIM5_TARGET.md:15:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:303:./docs/math/DDYO_RA1N_MOMENT_BOUND_PROOF.md:6:\left| \int x_\ell \, G_j(x) \, e^{(j)}_{ab}(D) \omega_k(x) \, dx \right| \le C \, 2^{-j} 2^{-k} \|\omega_k\|_{L^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-304-./docs/math/DDYO_RA1N_MOMENT_BOUND_PROOF.md:17:   - Since $\hat{G}_j(\xi) = \phi(2^{-j}\xi)$, we have $\partial_{\xi_\ell} \hat{G}_j \sim 2^{-j}$.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-305-./docs/math/DDYO_ALMOST_ORTHOGONALITY_GAIN.md:7:\int |K_j(z)|\,|z|\,dz \lesssim 2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-306-./docs/math/DDYO_ALMOST_ORTHOGONALITY_GAIN.md:9:the remaining task is to extract one further effective \(2^{-j}\) from shell localization / almost-orthogonality.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-307-./docs/math/DDYO_ALMOST_ORTHOGONALITY_GAIN.md:52:C\,2^{-j}2^{-k}\,\|\nabla S_k\|_{L^\infty}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-308-./docs/math/DDYO_ALMOST_ORTHOGONALITY_GAIN.md:57:This produces the second effective \(2^{-j}\), closes
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:309:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:310:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:14:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-311-./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:22:C\,2^{-j}2^{-k}\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:312:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:31:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-313-./docs/math/DDYO_OPEN_PROBLEM_SHELL_PRODUCT_MOMENT.md:12:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-314-./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:12:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-315-./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:21:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-316-./docs/math/DDYO_RA1N_PROOF.md:16:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-320-./docs/math/DDYO_CRITICAL_ENVELOPE.md:8:\sup_{j\in\mathbb Z} 2^{-j}\|\Delta_j u\|_{L^\infty(\mathbb R^3)}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-321-./docs/math/DDYO_CRITICAL_ENVELOPE.md:27:2^{-j}\|\Delta_j u_\mu\|_{L^\infty}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-322-./docs/math/DDYO_CRITICAL_ENVELOPE.md:46:\sup_j 2^{-j}\|\Delta_j u\|_{L^\infty},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-323-./docs/math/DDYO_POST_SYMMETRIZED_FIRST_ORDER_LEAKAGE.md:28:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:324:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-325-./docs/math/DDYO_HYBRID_CLAIM5_ROUTE.md:34:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-326-./docs/math/DDYO_HYBRID_CLAIM5_ROUTE.md:42:The first factor \(2^{-j}\) is supplied by the kernel first moment:
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-327-./docs/math/DDYO_HYBRID_CLAIM5_ROUTE.md:44:\int |K_j(z)|\,|z|\,dz \lesssim 2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-328-./docs/math/DDYO_PAIRED_DECOMPOSITION_5P_COVERAGE.md:23:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-329-./docs/math/DDYO_PAIRED_DECOMPOSITION_5P_COVERAGE.md:64:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:330:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:52:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-331-./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:60:C\,2^{-j}2^{-k}\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:332:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:67:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:333:./docs/math/DDYO_MASSIVE_REDUCTION.md:49:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-334-./docs/math/DDYO_MASSIVE_REDUCTION.md:89:C\,2^{-j}2^{-k}\|\omega_k\|_{L^1},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:335:./docs/math/DDYO_MASSIVE_REDUCTION.md:100:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:336:./docs/math/DDYO_MASSIVE_REDUCTION.md:131:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:337:./docs/math/DDYO_MASSIVE_REDUCTION.md:147:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:338:./docs/math/DDYO_MASSIVE_REDUCTION.md:169:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:339:./docs/math/DDYO_MASSIVE_REDUCTION.md:186:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-340-./docs/math/BRANCH_B_FINAL_FRONTIER.md:19:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-341-./docs/math/BRANCH_B_FINAL_FRONTIER.md:44:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-342-./docs/math/BRANCH_B_FINAL_FRONTIER.md:58:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-343-./docs/math/BRANCH_B_FINAL_FRONTIER.md:80:C\,2^{-j}2^{-k}\,
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-347-./docs/math/BRANCH_B_FINAL_FRONTIER.md:171:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-348-./docs/math/BRANCH_B_FINAL_FRONTIER.md:192:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-349-./docs/math/BRANCH_B_FINAL_FRONTIER.md:219:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-350-./docs/math/BRANCH_B_FINAL_FRONTIER.md:236:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:351:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-352-./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:28:C\,2^{-j}2^{-k}\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:353:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:49:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-354-./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:57:C\,2^{-j}2^{-k}\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:355:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:64:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-356-./docs/math/VARIANT_FRAMEWORK_STATUS.md:89:\sup_{j\in\mathbb Z} 2^{-j}\|\Delta_j u\|_{L^\infty(\mathbb R^3)}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-357-./docs/math/VARIANT_FRAMEWORK_STATUS.md:98:\sup_j 2^{-j}\|\Delta_j u\|_{L^\infty}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-358-./docs/math/DDYO_RA1N_OPEN_PROBLEM.md:11:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:359:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:16:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-360-./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:12:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-361-./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:37:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-362-./docs/math/DDYO_MOLLIFIED_PROJECTOR_REDUCTION.md:7:\widetilde m_j(\xi)=\rho(2^{-j}\xi),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-363-./docs/math/DDYO_MOLLIFIED_PROJECTOR_REDUCTION.md:21:C\,2^{-j}\|\nabla f\|_{L^\infty}\|g\|_{L^1}
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-370-./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:27:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-371-./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:37:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-372-./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:46:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-373-./docs/math/DDYO_RA1N_TARGET_THEOREM.md:11:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:374:./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:20:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-375-./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:33:C\,2^{-j}2^{-k}\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-376-./docs/math/DDYO_SOLVE_REQUIREMENTS.md:18:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-377-./docs/math/DDYO_SOLVE_REQUIREMENTS.md:26:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-378-./docs/math/DDYO_SOLVE_REQUIREMENTS.md:37:C\,2^{-j}2^{-k}\,
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-382-./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:11:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-383-./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:25:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-384-./docs/math/DDYO_REMAINDER_ROUTING_LEMMA.md:19:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-385-./docs/math/DDYO_CLAIM5_FINAL_DICHOTOMY.md:26:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:386:./docs/math/DDYO_RA1N_GJ_DEFINITION_STATUS.md:11:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-387-./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:41:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-388-./docs/math/DDYO_PAIRING_IBP_FRONTIER.md:76:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-389-./docs/math/DDYO_H_PRIME_ROUTE_CRITERION.md:89:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-390-./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:14:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-391-./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:22:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-392-./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:33:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-393-./docs/math/BRANCH_B_MISSING_MATH_AND_TEST.md:55:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:394:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:395:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:17:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:52:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:396:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:19:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:67:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:397:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:20:./docs/math/DDYO_RA1N_ANNULAR_POTENTIAL_ESTIMATE.md:40:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:398:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:26:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:49:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:399:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:28:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:64:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:400:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:41:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:401:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:61:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:402:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:62:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:14:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:403:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:64:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:31:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:404:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:70:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:405:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:73:./docs/math/DDYO_RA1N_MOMENT_BOUND_PROOF.md:6:\left| \int x_\ell \, G_j(x) \, e^{(j)}_{ab}(D) \omega_k(x) \, dx \right| \le C \, 2^{-j} 2^{-k} \|\omega_k\|_{L^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:406:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:75:./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:20:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:407:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:88:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-408-./docs/math/DDYO_SECOND_GAIN_ROUTE.md:34:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-409-./docs/math/DDYO_SECOND_GAIN_ROUTE.md:55:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-410-./docs/math/DDYO_SECOND_GAIN_ROUTE.md:69:2^{-j}2^{-k}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-411-./docs/math/DDYO_FIRST_ORDER_LEAKAGE_SPLIT.md:33:C\,2^{-j}2^{-k}\,
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-415-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-416-## Existing gradient-bound hits
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-417-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-418-```text
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:419:./docs/math/DDYO_RA1N_ANNULAR_POTENTIAL_ESTIMATE.md:40:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:420:./docs/math/DDYO_MASSIVE_REDUCTION.md:49:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:421:./docs/math/DDYO_MASSIVE_REDUCTION.md:100:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:422:./docs/math/DDYO_MASSIVE_REDUCTION.md:131:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:423:./docs/math/DDYO_MASSIVE_REDUCTION.md:147:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:424:./docs/math/DDYO_MASSIVE_REDUCTION.md:169:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:425:./docs/math/DDYO_MASSIVE_REDUCTION.md:186:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:426:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:427:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:17:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:52:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:428:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:19:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:67:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:429:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:20:./docs/math/DDYO_RA1N_ANNULAR_POTENTIAL_ESTIMATE.md:40:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:430:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:25:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:44:\|\nabla(x_\ell G_j)\|_{L^\infty}\,\|H^{ab}_{j,k}\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:431:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:26:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:49:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:432:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:28:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:64:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:433:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:41:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:434:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:61:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:435:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:62:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:14:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:436:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:64:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:31:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:437:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:70:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:438:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:75:./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:20:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:439:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:88:./docs/math/DDYO_RA1N_GJ_PROVENANCE_AUDIT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:440:./docs/math/DDYO_RA1N_GJ_DEFINITION_STATUS.md:11:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:441:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:442:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:52:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:443:./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:67:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:444:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:16:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:445:./docs/math/DDYO_RA1N_GRADIENT_BOUND.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:446:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:44:\|\nabla(x_\ell G_j)\|_{L^\infty}\,\|H^{ab}_{j,k}\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:447:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:49:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:448:./docs/math/DDYO_RA1N_DIVERGENCE_REDUCTION.md:64:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:449:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:7:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:450:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:14:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:451:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:31:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:452:./docs/math/DDYO_TERMINAL_OBSTRUCTION.md:12:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:453:./docs/math/DDYO_TERMINAL_OBSTRUCTION.md:30:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:454:./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:20:\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-455-./docs/math/DDYO_MASSIVE_REDUCTION.md:184:No theorem-level proof of the gradient bound
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-456-./docs/math/DDYO_RA1N_FIXED_SCALE_SCHWARTZ_KERNEL.md:65:Conditional on the gradient bound
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-457-./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:20:No theorem-level derivation of the gradient bound is currently present in this repository.
...
--
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-17-
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-18-## RA1n (conditional closure atom)
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-19-Assume there exists \(C_{\mathrm{RA1n}}<\infty\) such that for all dyadic indices with \(|j-k|\le C\), all tensor indices \(a,b\), and all coordinate indices \(\ell\),
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-20-\[
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md:21:\int G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx=0,
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-22-\]
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-23-and
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-24-\[
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-25-\left|
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md:26:\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-27-\right|
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-28-\le
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-29-C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-30-\]
--
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-8-## Canonical theorem frontier
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-9-The sole remaining theorem-level frontier is the RA1n first-moment shell-product estimate:
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-10-\[
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-11-\left|
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md:12:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-13-\right|
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-14-\le
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-15-C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-16-\]
--
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-11-## Canonical theorem frontier
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-12-The sole remaining theorem-level frontier is the RA1n first-moment shell-product estimate:
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-13-\[
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-14-\left|
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md:15:\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-16-
ight|
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-17-\le
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-18-C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-19-\]
```
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-252-./docs/math/DDYO_HYBRID_CLAIM5_ROUTE.md:9:3. kernel symmetrization to remove the first-order paired leakage,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-253-./docs/math/DDYO_HYBRID_CLAIM5_ROUTE.md:42:The first factor \(2^{-j}\) is supplied by the kernel first moment:
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:254:./docs/math/DDYO_MINIMAL_MISSING_LEMMA.md:9:for some fixed kernel \(\Gamma\) satisfying
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-255-./docs/math/DDYO_CRITICAL_COMMUTATOR_LEMMA.md:5:For a smooth positive dyadic family \((\widetilde P_j)_j\) with even real symbol and kernels \(K_j\),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-256-./docs/math/DDYO_RA1N_MULTIPLIER_KERNEL_ROUTE.md:13:the desired annular potential estimate follows from the kernel bound
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-257-./docs/math/DDYO_RA1N_MULTIPLIER_KERNEL_ROUTE.md:63:equivalently that the annular cutoff removes the origin singularity and yields an \(L^1\) Schwartz kernel at unit scale.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-258-./docs/math/DDYO_POST_SYMMETRIZED_FIRST_ORDER_LEAKAGE.md:9:denote the first-order Taylor contribution to the paired commutator remainder after kernel symmetrization in the hybrid route.
--
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-283-./docs/math/DDYO_SYMMETRIC_COMMUTATOR_PAIRING_FRONTIER.md:31:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [P_j,S_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-284-./docs/math/DDYO_SYMMETRIC_COMMUTATOR_PAIRING_FRONTIER.md:68:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,\Omega_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx = 0,
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:229:./tests/test_ddyo_hybrid_proxy.py:31:    K = make_even_gaussian_kernel(n, sigma_pts)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:230:./tests/test_ddyo_hybrid_proxy.py:53:def test_hybrid_proxy_even_kernel_has_zero_signed_first_moment():
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:231:./tests/test_ddyo_hybrid_proxy.py:55:    K = make_even_gaussian_kernel(n, sigma_pts=3.0)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:232:./modules/rh/experiments/akcl_normalized_scan.py:8:def kernel(x, y):
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:233:./modules/rh/experiments/akcl_normalized_scan.py:16:            E += kernel(x, y) * weight(x) * weight(y)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:234:./modules/rh/experiments/akcl_normalized_scan.py:25:            s += kernel(x, y) * weight(y)
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:235:./docs/yang_mills/block_poincare/plaquette_quadratic_form.md:86:- kernel removed by axial gauge fixing
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:236:./docs/math/DDYO_KERNEL_FIRST_MOMENT_LEMMA.md:3:## Candidate kernel first-moment bound
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:237:./docs/math/DDYO_KERNEL_FIRST_MOMENT_LEMMA.md:5:For the smooth positive dyadic projector \(\widetilde P_j\) with kernel \(K_j\),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:238:./docs/math/DDYO_ALMOST_ORTHOGONALITY_GAIN.md:5:After the kernel first-moment estimate
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:239:./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:28:For radial shell kernel and traceless shell multiplier,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:240:./docs/math/DDYO_PAIRED_DECOMPOSITION_5P_COVERAGE.md:37:into kernel form with \(K_j(x-y)\).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:241:./docs/math/DDYO_PAIRED_DECOMPOSITION_5P_COVERAGE.md:40:Rewrite the kernel pairing as a sum of terms symmetric and antisymmetric under
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:242:./docs/math/DDYO_GENUINE_DIPOLE_CANCELLATION_ROUTE.md:15:The remaining terminal target is to prove that the first-order Taylor contribution in the paired remainder is itself orthogonal to the shell interaction after kernel symmetrization, so that the remainder behaves as a dipole and gains the second factor
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:243:./docs/math/DDYO_GENUINE_DIPOLE_CANCELLATION_ROUTE.md:30:where the first \(2^{-j}\) comes from the kernel first moment and the second \(2^{-k}\) comes from genuine paired dipole / Taylor / kernel cancellation.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:244:./docs/math/DDYO_GENUINE_DIPOLE_CANCELLATION_ROUTE.md:42:after shell-frequency localization and kernel symmetrization, leaving only a second-order remainder with net gain
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:245:./docs/math/DDYO_MASSIVE_REDUCTION.md:56:\text{fixed-scale Schwartz-kernel bound}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:246:./docs/math/DDYO_MASSIVE_REDUCTION.md:60:\text{fixed-scale Schwartz-kernel bound}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:247:./docs/math/DDYO_MASSIVE_REDUCTION.md:105:The annular potential estimate reduces to the fixed-scale multiplier-kernel route:
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:248:./docs/math/DDYO_MASSIVE_REDUCTION.md:125:At fixed scale, the annular cutoff removes the origin singularity, so the multiplier is smooth and compactly supported away from the singular point. This is the recorded local route to the \(L^1\) kernel bound.
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-362-./docs/math/DDYO_MOLLIFIED_PROJECTOR_REDUCTION.md:7:\widetilde m_j(\xi)=\rho(2^{-j}\xi),
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-363-./docs/math/DDYO_MOLLIFIED_PROJECTOR_REDUCTION.md:21:C\,2^{-j}\|\nabla f\|_{L^\infty}\|g\|_{L^1}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-364-./docs/math/DDYO_GENUINE_DIPOLE_CANCELLATION_ROUTE.md:26:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:365:./docs/math/DDYO_GENUINE_DIPOLE_CANCELLATION_ROUTE.md:30:where the first \(2^{-j}\) comes from the kernel first moment and the second \(2^{-k}\) comes from genuine paired dipole / Taylor / kernel cancellation.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-366-./docs/math/DDYO_GENUINE_DIPOLE_CANCELLATION_ROUTE.md:44:2^{-j}2^{-k}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-367-./docs/math/DDYO_CLAIM5_POST_COUNTEREXAMPLE_BRANCH.md:17:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-368-./docs/math/DDYO_CLAIM5_POST_COUNTEREXAMPLE_BRANCH.md:35:\int |K_j(z)|\,|z|\,dz \lesssim 2^{-j}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-369-./docs/math/DDYO_RA1N_VERIFIED_LEMMA.md:18:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
--
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-268-## Dyadic-scaling hits
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-269-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-270-```text
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:271:./docs/math/DDYO_ALMOST_ORTHOGONALITY_GAIN.md:17:2^{2j}\!\int \mathcal H'(\omega_j)\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:272:./docs/math/DDYO_MOLLIFIED_PROJECTOR_REDUCTION.md:29:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,\Omega_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx = 0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:273:./docs/math/DDYO_MOLLIFIED_PROJECTOR_REDUCTION.md:34:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,S_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:274:./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:11:extract the exact shellwise gain needed to offset the DDYO weight \(2^{2j}\).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:275:./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:61:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:276:./artifacts/branch_b/branch_b_relevant_hits.log:78:docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:11:extract the exact shellwise gain needed to offset the DDYO weight \(2^{2j}\).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:277:./artifacts/branch_b/branch_b_relevant_hits.log:197:./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:11:extract the exact shellwise gain needed to offset the DDYO weight \(2^{2j}\).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:278:./docs/math/DDYO_CRITICAL_COMMUTATOR_LEMMA.md:8:2^{2j}\left|
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:279:./docs/math/DDYO_CRITICAL_COMMUTATOR_LEMMA.md:55:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,S_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:280:./docs/math/DDYO_MOLLIFIED_SKEW_CANCELLATION.md:10:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,\Omega_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx = 0.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:281:./docs/math/DDYO_SECOND_GAIN_ROUTE.md:76:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:282:./docs/math/DDYO_SYMMETRIC_COMMUTATOR_PAIRING_FRONTIER.md:24:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [P_j,\Omega_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx = 0
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:283:./docs/math/DDYO_SYMMETRIC_COMMUTATOR_PAIRING_FRONTIER.md:31:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [P_j,S_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:284:./docs/math/DDYO_SYMMETRIC_COMMUTATOR_PAIRING_FRONTIER.md:68:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,\Omega_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx = 0,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:285:./docs/math/DDYO_SYMMETRIC_COMMUTATOR_PAIRING_FRONTIER.md:73:\sum_j 2^{2j}\!\int \mathcal H'(\omega_j)\cdot [\widetilde P_j,S_{\sim j}\!\cdot\nabla]\omega_{\sim j}\,dx
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:286:./docs/math/BRANCH_B_CLOSURE_CHECKLIST.md:119:- `docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:11:extract the exact shellwise gain needed to offset the DDYO weight \(2^{2j}\).`
...
--
./artifacts/branch_b/branch_b_relevant_hits.log-74-docs/math/DDYO_CLAIM5_FINAL_DICHOTOMY.md:14:### Branch B: lower-order routing
./artifacts/branch_b/branch_b_relevant_hits.log-75-docs/math/DDYO_CLAIM5_FINAL_DICHOTOMY.md:18:C_\varepsilon\bigl(\Phi[u]+\lambda R^{\mathrm{cont}}_{\mathrm{DDYO}}[u]\bigr)_{j,k}.
./artifacts/branch_b/branch_b_relevant_hits.log-76-docs/math/DDYO_CLAIM5_FINAL_DICHOTOMY.md:35:This is the minimal remaining object for hybrid DDYO Claim 5 after first-order post-symmetrization.
./artifacts/branch_b/branch_b_relevant_hits.log-77-docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:1:# DDYO Dyadic Gain Extraction
./artifacts/branch_b/branch_b_relevant_hits.log:78:docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:11:extract the exact shellwise gain needed to offset the DDYO weight \(2^{2j}\).
./artifacts/branch_b/branch_b_relevant_hits.log-79-docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:25:\varepsilon\,\lambda^{-1}\bigl(\mathcal D[u]+\lambda\mathcal C_{\mathrm{DDYO}}[u]\bigr)
./artifacts/branch_b/branch_b_relevant_hits.log-80-docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:27:C_\varepsilon\bigl(\Phi[u]+\lambda R^{\mathrm{cont}}_{\mathrm{DDYO}}[u]\bigr),
./artifacts/branch_b/branch_b_relevant_hits.log-81-docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:64:with one global \(\varepsilon<1\), completing the DDYO continuum high-high absorbability step.
./artifacts/branch_b/branch_b_relevant_hits.log-82-docs/math/DDYO_CLAIM5_POST_COUNTEREXAMPLE_BRANCH.md:1:# DDYO Claim 5 Post-Counterexample Branch
--
./artifacts/branch_b/branch_b_relevant_hits.log-193-./docs/math/DDYO_CLAIM5_FINAL_DICHOTOMY.md:14:### Branch B: lower-order routing
./artifacts/branch_b/branch_b_relevant_hits.log-194-./docs/math/DDYO_CLAIM5_FINAL_DICHOTOMY.md:18:C_\varepsilon\bigl(\Phi[u]+\lambda R^{\mathrm{cont}}_{\mathrm{DDYO}}[u]\bigr)_{j,k}.
./artifacts/branch_b/branch_b_relevant_hits.log-195-./docs/math/DDYO_CLAIM5_FINAL_DICHOTOMY.md:35:This is the minimal remaining object for hybrid DDYO Claim 5 after first-order post-symmetrization.
./artifacts/branch_b/branch_b_relevant_hits.log-196-./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:1:# DDYO Dyadic Gain Extraction
./artifacts/branch_b/branch_b_relevant_hits.log:197:./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:11:extract the exact shellwise gain needed to offset the DDYO weight \(2^{2j}\).
./artifacts/branch_b/branch_b_relevant_hits.log-198-./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:25:\varepsilon\,\lambda^{-1}\bigl(\mathcal D[u]+\lambda\mathcal C_{\mathrm{DDYO}}[u]\bigr)
./artifacts/branch_b/branch_b_relevant_hits.log-199-./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:27:C_\varepsilon\bigl(\Phi[u]+\lambda R^{\mathrm{cont}}_{\mathrm{DDYO}}[u]\bigr),
./artifacts/branch_b/branch_b_relevant_hits.log-200-./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:64:with one global \(\varepsilon<1\), completing the DDYO continuum high-high absorbability step.
./artifacts/branch_b/branch_b_relevant_hits.log-201-./docs/math/DDYO_CLAIM5_POST_COUNTEREXAMPLE_BRANCH.md:1:# DDYO Claim 5 Post-Counterexample Branch
--
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-293-./artifacts/branch_b/branch_b_open_hits.log:21:docs/status/DDYO_RA1N_STATUS_2026_04_10.md:29:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-294-./artifacts/branch_b/branch_b_open_hits.log:50:docs/math/DDYO_RA1N_CONDITIONAL.md:18:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./artifacts/branch_b/branch_b_frontier_matrix.md-35-  L8: Assume there exists a constant \(C_{\mathrm{RA1n}}<\infty\) such that for all dyadic indices with \(|j-k|\le C\), all tensor indices \(a,b\), and all coordinate indices \(\ell\),
./artifacts/branch_b/branch_b_frontier_matrix.md-36-  L9: \[
./artifacts/branch_b/branch_b_frontier_matrix.md-37-- tags: `branchb`
./artifacts/branch_b/branch_b_frontier_matrix.md-38-  L17: \le
./artifacts/branch_b/branch_b_frontier_matrix.md:39:  L18: C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./artifacts/branch_b/branch_b_frontier_matrix.md-40-  L19: \]
./artifacts/branch_b/branch_b_frontier_matrix.md-41-- tags: `close,branchb`
./artifacts/branch_b/branch_b_frontier_matrix.md-42-  L22: 
./artifacts/branch_b/branch_b_frontier_matrix.md-43-  L23: RA1n implies the shell-product \(H^1\) gain
--
...
./artifacts/branch_b/branch_b_open_hits.log-19-docs/status/DDYO_RA1N_STATUS_2026_04_10.md:18:## RA1n (conditional closure atom)
./artifacts/branch_b/branch_b_open_hits.log-20-docs/status/DDYO_RA1N_STATUS_2026_04_10.md:19:Assume there exists \(C_{\mathrm{RA1n}}<\infty\) such that for all dyadic indices with \(|j-k|\le C\), all tensor indices \(a,b\), and all coordinate indices \(\ell\),
...
./artifacts/branch_b/branch_b_open_hits.log-47-docs/math/DDYO_RA1N_CONDITIONAL.md:1:# DDYO RA1n (Conditional)
./artifacts/branch_b/branch_b_open_hits.log-48-docs/math/DDYO_RA1N_CONDITIONAL.md:4:RA1n = Rigidity Atom 1n
./artifacts/branch_b/branch_b_open_hits.log-49-docs/math/DDYO_RA1N_CONDITIONAL.md:8:Assume there exists a constant \(C_{\mathrm{RA1n}}<\infty\) such that for all dyadic indices with \(|j-k|\le C\), all tensor indices \(a,b\), and all coordinate indices \(\ell\),
./artifacts/branch_b/branch_b_open_hits.log:50:docs/math/DDYO_RA1N_CONDITIONAL.md:18:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./artifacts/branch_b/branch_b_open_hits.log-51-docs/math/DDYO_RA1N_CONDITIONAL.md:23:RA1n implies the shell-product \(H^1\) gain
./artifacts/branch_b/branch_b_open_hits.log-52-docs/math/DDYO_RA1N_CONDITIONAL.md:30:Hence RA1n implies the deviatoric coercivity estimate
./artifacts/branch_b/branch_b_open_hits.log-53-docs/math/DDYO_RA1N_CONDITIONAL.md:42:Hence RA1n implies Claim 5 / paired remainder closure
./artifacts/branch_b/branch_b_open_hits.log-54-docs/math/DDYO_RA1N_CONDITIONAL.md:51:Hence RA1n implies high-high absorbability closure and final DDYO continuum closure.
--
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-11-\left|
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-12-\int_{\mathbb R^3} x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-13-\right|
...
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md:15:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-16-\]
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-17-
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-18-## Canonical status
./docs/status/SCIENTIFIC_MATURITY_CHECKPOINT_2026_04_11.md-19-- Computationally closed.
--
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-25-\left|
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-26-\int x_\ell\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-27-\right|
...
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md:29:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-30-\]
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-31-
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-32-## Consequence
./docs/status/DDYO_RA1N_STATUS_2026_04_10.md-33-If RA1n holds, then the shell-product \(H^1\) gain, deviatoric coercivity estimate,
--
./docs/math/BRANCH_B_FINAL_FRONTIER.md-15-\left|
./docs/math/BRANCH_B_FINAL_FRONTIER.md-16-\int x_l\,G_j(x)\,e^{(j)}_{ab}(D)\omega_k(x)\,dx
./docs/math/BRANCH_B_FINAL_FRONTIER.md-17-\right|
...
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md:18:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-19-\]
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-20-
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-21-## Canonical status
./docs/status/SCIENTIFIC_MATURITY_CURRENT.md-22-- Computationally closed.
--
./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md-8-\int G_j\cdot
./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md-9-\Bigl(\sum_{a,b}\partial_b S_k^a\,e^{(j)}_{ab}(D)\omega_k\Bigr)\,dx
./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md-10-\right|
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:315:./docs/math/DDYO_DEVIATORIC_H1_BMO_ROUTE.md:21:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:316:./docs/math/DDYO_RA1N_PROOF.md:16:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:317:./docs/math/DDYO_PAIRED_PARACOMMUTATOR_H1_BMO.md:11:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:318:./docs/math/DDYO_PAIRED_PARACOMMUTATOR_H1_BMO.md:19:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:319:./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:21:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:320:./docs/math/DDYO_CRITICAL_ENVELOPE.md:8:\sup_{j\in\mathbb Z} 2^{-j}\|\Delta_j u\|_{L^\infty(\mathbb R^3)}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:321:./docs/math/DDYO_CRITICAL_ENVELOPE.md:27:2^{-j}\|\Delta_j u_\mu\|_{L^\infty}
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:322:./docs/math/DDYO_CRITICAL_ENVELOPE.md:46:\sup_j 2^{-j}\|\Delta_j u\|_{L^\infty},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:323:./docs/math/DDYO_POST_SYMMETRIZED_FIRST_ORDER_LEAKAGE.md:28:C\,2^{-j}2^{-k}\,
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:342:./docs/math/BRANCH_B_FINAL_FRONTIER.md:58:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:343:./docs/math/BRANCH_B_FINAL_FRONTIER.md:80:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:344:./docs/math/BRANCH_B_FINAL_FRONTIER.md:105:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:345:./docs/math/BRANCH_B_FINAL_FRONTIER.md:152:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:346:./docs/math/BRANCH_B_FINAL_FRONTIER.md:160:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:347:./docs/math/BRANCH_B_FINAL_FRONTIER.md:171:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:348:./docs/math/BRANCH_B_FINAL_FRONTIER.md:192:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:349:./docs/math/BRANCH_B_FINAL_FRONTIER.md:219:C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:350:./docs/math/BRANCH_B_FINAL_FRONTIER.md:236:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:377:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:26:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:378:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:37:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:379:./docs/math/DDYO_SOLVE_REQUIREMENTS.md:47:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:380:./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:53:\int |K_j(z)|\,|z|\,dz \lesssim 2^{-j},
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:381:./docs/math/DDYO_DYADIC_GAIN_EXTRACTION.md:55:and recover one additional effective \(2^{-j}\) from the shell localization / almost-orthogonality structure, yielding net \(2^{-2j}\).
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:382:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:11:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:383:./docs/math/DDYO_SHELL_PRODUCT_MOMENT_FRONTIER.md:25:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:384:./docs/math/DDYO_REMAINDER_ROUTING_LEMMA.md:19:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:385:./docs/math/DDYO_CLAIM5_FINAL_DICHOTOMY.md:26:C\,2^{-j}2^{-k}\,
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:410:./docs/math/DDYO_SECOND_GAIN_ROUTE.md:69:2^{-j}2^{-k}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:411:./docs/math/DDYO_FIRST_ORDER_LEAKAGE_SPLIT.md:33:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:412:./docs/math/DDYO_SHELL_MOMENT_LEMMA.md:18:C\,2^{-j}2^{-k}\,
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:413:./docs/math/DDYO_CANONICAL_FRONTIER.md:11:C\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-414-```
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-415-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-416-## Existing gradient-bound hits
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-417-
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-418-```text
...
./artifacts/branch_b/branch_b_frontier_matrix.md-31-  L6: ## Conditional statement
./artifacts/branch_b/branch_b_frontier_matrix.md-32-  L7: 
./artifacts/branch_b/branch_b_frontier_matrix.md-33-- tags: `branchb`
./artifacts/branch_b/branch_b_frontier_matrix.md-34-  L7: 
./artifacts/branch_b/branch_b_frontier_matrix.md:35:  L8: Assume there exists a constant \(C_{\mathrm{RA1n}}<\infty\) such that for all dyadic indices with \(|j-k|\le C\), all tensor indices \(a,b\), and all coordinate indices \(\ell\),
./artifacts/branch_b/branch_b_frontier_matrix.md-36-  L9: \[
./artifacts/branch_b/branch_b_frontier_matrix.md-37-- tags: `branchb`
./artifacts/branch_b/branch_b_frontier_matrix.md-38-  L17: \le
./artifacts/branch_b/branch_b_frontier_matrix.md-39-  L18: C_{\mathrm{RA1n}}\,2^{-j}2^{-k}\,\|\omega_k\|_{L^1}.
--
./artifacts/branch_b/branch_b_frontier_matrix.md-55-  L51: \]
./artifacts/branch_b/branch_b_frontier_matrix.md-56-- tags: `close,branchb`
./artifacts/branch_b/branch_b_frontier_matrix.md-57-  L52: 
./artifacts/branch_b/branch_b_frontier_matrix.md-58-  L53: ### 5. Claim 5 / paired remainder closure
./artifacts/branch_b/branch_b_frontier_matrix.md:59:  L54: For all dyadic indices with \(|j-k|\le C\),
./artifacts/branch_b/branch_b_frontier_matrix.md-60-- tags: `close`
./artifacts/branch_b/branch_b_frontier_matrix.md-61-  L62: 
./artifacts/branch_b/branch_b_frontier_matrix.md-62-  L63: ### 6. Final DDYO continuum closure
./artifacts/branch_b/branch_b_frontier_matrix.md-63-  L64: High-high absorbability closes, hence the DDYO continuum argument closes.
--
./artifacts/branch_b/branch_b_frontier_matrix.md-277-  L13: - docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md
./artifacts/branch_b/branch_b_frontier_matrix.md-278-- tags: `open`
./artifacts/branch_b/branch_b_frontier_matrix.md-279-  L15: 
./artifacts/branch_b/branch_b_frontier_matrix.md-280-  L16: ## Current weakest sufficient remaining lemma
./artifacts/branch_b/branch_b_frontier_matrix.md:281:  L17: For all dyadic indices with |j-k| <= C, all tensor indices a,b, and all coordinate indices l,
./artifacts/branch_b/branch_b_frontier_matrix.md-282-- tags: `open`
./artifacts/branch_b/branch_b_frontier_matrix.md-283-  L29: \]
./artifacts/branch_b/branch_b_frontier_matrix.md-284-  L30: this is sufficient to recover the shell-product H^1 gain and the target deviatoric coercivity bound.
./artifacts/branch_b/branch_b_frontier_matrix.md-285-  L31: 
--
./artifacts/branch_b/branch_b_frontier_matrix.md-306-  L15: - docs/math/DDYO_SOLVE_REQUIREMENTS.md
./artifacts/branch_b/branch_b_frontier_matrix.md-307-- tags: `open,close,branchb`
./artifacts/branch_b/branch_b_frontier_matrix.md-308-  L17: 
./artifacts/branch_b/branch_b_frontier_matrix.md-309-  L18: ## RA1n (conditional closure atom)
./artifacts/branch_b/branch_b_frontier_matrix.md:310:  L19: Assume there exists \(C_{\mathrm{RA1n}}<\infty\) such that for all dyadic indices with \(|j-k|\le C\), all tensor indices \(a,b\), and all coordinate indices \(\ell\),
./artifacts/branch_b/branch_b_frontier_matrix.md-311-- tags: `branchb`
./artifacts/branch_b/branch_b_frontier_matrix.md-312-  L18: ## RA1n (conditional closure atom)
./artifacts/branch_b/branch_b_frontier_matrix.md:313:  L19: Assume there exists \(C_{\mathrm{RA1n}}<\infty\) such that for all dyadic indices with \(|j-k|\le C\), all tensor indices \(a,b\), and all coordinate indices \(\ell\),
./artifacts/branch_b/branch_b_frontier_matrix.md-314-  L20: \[
./artifacts/branch_b/branch_b_frontier_matrix.md-315-
./artifacts/branch_b/branch_b_frontier_matrix.md-316-### docs/status/NAVIER_STOKES_FRONTIER_SNAPSHOT_2026_04_10.md
./artifacts/branch_b/branch_b_frontier_matrix.md-317-Status: **OPEN**
--
...
./artifacts/branch_b/branch_b_open_hits.log-53-docs/math/DDYO_RA1N_CONDITIONAL.md:42:Hence RA1n implies Claim 5 / paired remainder closure
--
./artifacts/branch_b/branch_b_relevant_hits.log-41-docs/math/VARIANT_FRAMEWORK_STATUS.md:83:## DDYO
./artifacts/branch_b/branch_b_relevant_hits.log-42-docs/math/VARIANT_FRAMEWORK_STATUS.md:87:R_{\mathrm{DDYO}}[u]
./artifacts/branch_b/branch_b_relevant_hits.log-43-docs/math/VARIANT_FRAMEWORK_STATUS.md:96:R_{\mathrm{DDYO}}^{\mathrm{test}}
./artifacts/branch_b/branch_b_relevant_hits.log-44-docs/math/VARIANT_FRAMEWORK_STATUS.md:111:R_{\mathrm{DDYO}}[u]=\|u\|_{\dot B^{-1}_{\infty,\infty}}
./artifacts/branch_b/branch_b_relevant_hits.log:45:docs/math/VARIANT_FRAMEWORK_STATUS.md:121:- DDYO sampled dyadic-envelope layer
./artifacts/branch_b/branch_b_relevant_hits.log-46-docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:1:# DDYO Deviatoric Coercivity Frontier
./artifacts/branch_b/branch_b_relevant_hits.log-47-docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:28:C_\varepsilon\Bigl(\Phi[u]+\lambda R^{\mathrm{cont}}_{\mathrm{DDYO}}[u]\Bigr)_{j,k}.
./artifacts/branch_b/branch_b_relevant_hits.log-48-docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:1:# DDYO Paired Decomposition Lemma
./artifacts/branch_b/branch_b_relevant_hits.log-49-docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:68:This lemma implies the pairing-level second-gain estimate and closes the DDYO continuum high-high absorbability step.
--
./artifacts/branch_b/branch_b_relevant_hits.log-160-./docs/math/VARIANT_FRAMEWORK_STATUS.md:83:## DDYO
./artifacts/branch_b/branch_b_relevant_hits.log-161-./docs/math/VARIANT_FRAMEWORK_STATUS.md:87:R_{\mathrm{DDYO}}[u]
./artifacts/branch_b/branch_b_relevant_hits.log-162-./docs/math/VARIANT_FRAMEWORK_STATUS.md:96:R_{\mathrm{DDYO}}^{\mathrm{test}}
./artifacts/branch_b/branch_b_relevant_hits.log-163-./docs/math/VARIANT_FRAMEWORK_STATUS.md:111:R_{\mathrm{DDYO}}[u]=\|u\|_{\dot B^{-1}_{\infty,\infty}}
./artifacts/branch_b/branch_b_relevant_hits.log:164:./docs/math/VARIANT_FRAMEWORK_STATUS.md:121:- DDYO sampled dyadic-envelope layer
./artifacts/branch_b/branch_b_relevant_hits.log-165-./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:1:# DDYO Deviatoric Coercivity Frontier
./artifacts/branch_b/branch_b_relevant_hits.log-166-./docs/math/DDYO_DEVIATORIC_COERCIVITY_FRONTIER.md:28:C_\varepsilon\Bigl(\Phi[u]+\lambda R^{\mathrm{cont}}_{\mathrm{DDYO}}[u]\Bigr)_{j,k}.
./artifacts/branch_b/branch_b_relevant_hits.log-167-./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:1:# DDYO Paired Decomposition Lemma
./artifacts/branch_b/branch_b_relevant_hits.log-168-./docs/math/DDYO_PAIRED_DECOMPOSITION_LEMMA.md:68:This lemma implies the pairing-level second-gain estimate and closes the DDYO continuum high-high absorbability step.
--
./artifacts/branch_b/branch_b_relevant_hits.log-252-./.git/logs/HEAD:25:58959e46b6082919e989e3b792c60bc0bbc0b259 88751acf1815f117e6d93292db1b0e83796e2979 Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775863902 -0300	commit: Add DDYO mollified projector reduction as next continuum step
./artifacts/branch_b/branch_b_relevant_hits.log-253-./.git/logs/HEAD:26:88751acf1815f117e6d93292db1b0e83796e2979 a3da88d5fd445fe1d3e7e0c22e103e999e9cf675 Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864003 -0300	commit: Add DDYO mollified skew cancellation as next continuum identity target
./artifacts/branch_b/branch_b_relevant_hits.log-254-./.git/logs/HEAD:27:a3da88d5fd445fe1d3e7e0c22e103e999e9cf675 5052fe3c0f662a9509ce39c57920f6afad68aa2f Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864080 -0300	commit: Add DDYO mollified symmetric commutator bound as current terminal estimate
./artifacts/branch_b/branch_b_relevant_hits.log-255-./.git/logs/HEAD:28:5052fe3c0f662a9509ce39c57920f6afad68aa2f cade9453739ef975c85f25a2a021ac085714bb98 Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864198 -0300	commit: Add DDYO critical commutator lemma as terminal new ingredient
./artifacts/branch_b/branch_b_relevant_hits.log:256:./.git/logs/HEAD:29:cade9453739ef975c85f25a2a021ac085714bb98 fec9c786516fd95315cc7fbf0ae8fdaeae62bf31 Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864307 -0300	commit: Add DDYO dyadic gain extraction as next shellwise reduction
./artifacts/branch_b/branch_b_relevant_hits.log-257-./.git/logs/HEAD:30:fec9c786516fd95315cc7fbf0ae8fdaeae62bf31 5447cd71a57f173a993edb1bb48de0f85594426d Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864520 -0300	commit: Add DDYO almost-orthogonality gain as final shellwise closure step
./artifacts/branch_b/branch_b_relevant_hits.log-258-./.git/logs/HEAD:31:5447cd71a57f173a993edb1bb48de0f85594426d 709312237eb7089ec9fa899f14acb896316c956a Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864695 -0300	commit: Add DDYO second-gain route and eliminate divergence-free strain branch
./artifacts/branch_b/branch_b_relevant_hits.log-259-./.git/logs/HEAD:32:709312237eb7089ec9fa899f14acb896316c956a 1e0a744e26b4737766914062df56adbdd3efb4fe Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864863 -0300	commit: Add DDYO H-prime route criterion and freeze pairing-level branch
./artifacts/branch_b/branch_b_relevant_hits.log-260-./.git/logs/HEAD:33:1e0a744e26b4737766914062df56adbdd3efb4fe c69a572b86713e4e390580f459119a9293b2c67b Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775865041 -0300	commit: Add DDYO pairing IBP frontier and symmetric-gradient extraction target
--
./artifacts/branch_b/branch_b_relevant_hits.log-294-./.git/logs/refs/heads/main:25:58959e46b6082919e989e3b792c60bc0bbc0b259 88751acf1815f117e6d93292db1b0e83796e2979 Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775863902 -0300	commit: Add DDYO mollified projector reduction as next continuum step
./artifacts/branch_b/branch_b_relevant_hits.log-295-./.git/logs/refs/heads/main:26:88751acf1815f117e6d93292db1b0e83796e2979 a3da88d5fd445fe1d3e7e0c22e103e999e9cf675 Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864003 -0300	commit: Add DDYO mollified skew cancellation as next continuum identity target
./artifacts/branch_b/branch_b_relevant_hits.log-296-./.git/logs/refs/heads/main:27:a3da88d5fd445fe1d3e7e0c22e103e999e9cf675 5052fe3c0f662a9509ce39c57920f6afad68aa2f Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864080 -0300	commit: Add DDYO mollified symmetric commutator bound as current terminal estimate
./artifacts/branch_b/branch_b_relevant_hits.log-297-./.git/logs/refs/heads/main:28:5052fe3c0f662a9509ce39c57920f6afad68aa2f cade9453739ef975c85f25a2a021ac085714bb98 Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864198 -0300	commit: Add DDYO critical commutator lemma as terminal new ingredient
./artifacts/branch_b/branch_b_relevant_hits.log:298:./.git/logs/refs/heads/main:29:cade9453739ef975c85f25a2a021ac085714bb98 fec9c786516fd95315cc7fbf0ae8fdaeae62bf31 Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864307 -0300	commit: Add DDYO dyadic gain extraction as next shellwise reduction
./artifacts/branch_b/branch_b_relevant_hits.log-299-./.git/logs/refs/heads/main:30:fec9c786516fd95315cc7fbf0ae8fdaeae62bf31 5447cd71a57f173a993edb1bb48de0f85594426d Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864520 -0300	commit: Add DDYO almost-orthogonality gain as final shellwise closure step
./artifacts/branch_b/branch_b_relevant_hits.log-300-./.git/logs/refs/heads/main:31:5447cd71a57f173a993edb1bb48de0f85594426d 709312237eb7089ec9fa899f14acb896316c956a Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864695 -0300	commit: Add DDYO second-gain route and eliminate divergence-free strain branch
./artifacts/branch_b/branch_b_relevant_hits.log-301-./.git/logs/refs/heads/main:32:709312237eb7089ec9fa899f14acb896316c956a 1e0a744e26b4737766914062df56adbdd3efb4fe Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775864863 -0300	commit: Add DDYO H-prime route criterion and freeze pairing-level branch
./artifacts/branch_b/branch_b_relevant_hits.log-302-./.git/logs/refs/heads/main:33:1e0a744e26b4737766914062df56adbdd3efb4fe c69a572b86713e4e390580f459119a9293b2c67b Inacio F. Vasquez <inaciovasquez2020@gmail.com> 1775865041 -0300	commit: Add DDYO pairing IBP frontier and symmetric-gradient extraction target
--
...
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:457:./docs/math/DDYO_RA1N_GRADIENT_BOUND_REQUIRED_INPUT.md:20:No theorem-level derivation of the gradient bound is currently present in this repository.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:458:./docs/math/DDYO_RA1N_REDUCTION_CHAIN.md:18:Assume also the gradient bound:
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md:459:./docs/math/DDYO_RA1N_SOLE_REMAINING_LOCAL_TASK.md:38:No theorem-level proof of the gradient bound is currently recorded in this repository.
./docs/math/DDYO_GJ_STRUCTURAL_CANDIDATES.md-460-```
