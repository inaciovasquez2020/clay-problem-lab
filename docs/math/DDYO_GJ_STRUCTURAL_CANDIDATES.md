# DDYO G_j Structural Candidates

## Purpose

Repository-wide structural search for the exact construction of \(G_j\) sufficient to prove
\[
\|\nabla(x_\ell G_j)\|_{L^\infty}\le C\,2^{-j}.
\]

## Literal hits for \(G_j\)
...
## Kernel / \(\Gamma\) / scaling-candidate hits
